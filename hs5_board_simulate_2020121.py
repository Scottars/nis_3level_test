...
def level1_udp_send():
    ...
    for i in range(100):
        ...
        client_socket.sendto(msg1, (nis_hsdd_configfile.hs5_udp_recv_addr,nis_hsdd_configfile.hs5_udp_recv_port))
        client_socket.sendto(msg2, (nis_hsdd_configfile.hs5_udp_recv_addr,nis_hsdd_configfile.hs5_udp_recv_port))
