...
def level1_udp_send():
    ...
    for i in range(100):
        ...
        msg1 = b''
        msg2 = b''
        channelid1 = struct.pack('!H', 5)
        channelid2 = struct.pack('!H', 6)
        ...
        client_socket.sendto(msg1, (nis_hsdd_configfile.hs3_udp_recv_addr,nis_hsdd_configfile.hs3_udp_recv_port))
        client_socket.sendto(msg2, (nis_hsdd_configfile.hs3_udp_recv_addr,nis_hsdd_configfile.hs3_udp_recv_port))
