...
def udp_recv_zmq_send(context, port):
    ...
    reveiver_url = nis_hsdd_configfile.hs4_sub_addr
    ...
    client_socket.bind((nis_hsdd_configfile.hs4_udp_recv_addr,nis_hsdd_configfile.hs4_udp_recv_port))
...
def zmq_monitor_thread(context):
    ...
    monitored_zmqaddr =nis_hsdd_configfile.level2_hs4_req_addr
