...
def level1_udp_send():
    ...
    for i in range(10000):
        ...
        msg1 = b''
        msg2 = b''
        channelid1 = struct.pack('!H', 3)
        channelid2 = struct.pack('!H', 4)
        ...
        client_socket.sendto(msg1, (nis_hsdd_configfile.hs2_udp_recv_addr,nis_hsdd_configfile.hs2_udp_recv_port))
        client_socket.sendto(msg2, (nis_hsdd_configfile.hs2_udp_recv_addr,nis_hsdd_configfile.hs2_udp_recv_port))
